...
class Section(Base):
    ...
    create_by = relationship('User', foreign_keys=[c_by], back_populates='created_sections')
    modify_by = relationship('User', foreign_keys=[m_by], back_populates='modified_sections')

    section_classes = relationship("AcademicYearClass", back_populates="section")
